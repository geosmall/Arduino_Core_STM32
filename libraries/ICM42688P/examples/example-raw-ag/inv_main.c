...
int inv_main(void)
{
	...
	/* Configure Icm426xx */
	rc = ConfigureInvDevice((uint8_t)IS_LOW_NOISE_MODE, (uint8_t)IS_HIGH_RES_MODE,
	                        ICM426XX_ACCEL_CONFIG0_FS_SEL_4g, ICM426XX_GYRO_CONFIG0_FS_SEL_2000dps,
	                        ICM426XX_ACCEL_CONFIG0_ODR_1_KHZ, ICM426XX_GYRO_CONFIG0_ODR_1_KHZ,
	                        (uint8_t)USE_CLK_IN);
