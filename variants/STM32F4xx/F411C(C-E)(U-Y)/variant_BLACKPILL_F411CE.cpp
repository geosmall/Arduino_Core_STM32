/*
 * variant_BLACKPILL_F411CE.cpp — Board-specific system clock configuration
 *
...
/**
  ...
  *         SYSCLK = 96 MHz for BlackPill F411CE (25 MHz HSE)
  *         25 MHz / 25 = 1 MHz → * 192 = 192 MHz VCO → / 2 = 96 MHz
