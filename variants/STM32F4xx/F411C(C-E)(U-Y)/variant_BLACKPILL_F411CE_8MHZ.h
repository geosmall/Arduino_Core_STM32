/*
 * variant_BLACKPILL_F411CE_8MHZ.h — WeAct BlackPill F411CE 8MHz (Pin refactor)
 *
 * FC variant with 8 MHz HSE crystal and UF2 bootloader support.
 *
...
// 8 MHz external crystal (WeAct Studio BlackPill v3.1)
