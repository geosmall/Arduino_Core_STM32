...
namespace BoardConfig {
  ...
  static constexpr StorageConfig storage{StorageBackend::LITTLEFS, PA7, PA6, PA5, PA4, 8000000, SpiDev::Spi1};
  ...
  static constexpr SPIConfig imu_spi{PB15, PB14, PB13, PB12, 1000000, SpiDev::Spi2};
