/*
 * variant_NUCLEO_F405RG.cpp — Board-specific system clock configuration
 *
...
/**
  ...
  *         SYSCLK = 168 MHz for NUCLEO_F405RG (custom mod, 8 MHz crystal)
