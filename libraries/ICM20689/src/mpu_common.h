...
/*
 * Common MPU register definitions shared across MPU-6000/MPU-9250
 * From Betaflight accgyro_mpu.h
 */
...
// DLPF configuration constants (for ICM-206xx and MPU-60x0)
