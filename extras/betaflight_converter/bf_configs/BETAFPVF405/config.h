...
// Serial RX assignment is not in the upstream BETAFPVF405 config.h; added here
// from the board's own Betaflight dump (serial 2 64 = USART3, RX_SERIAL) so the
// converter resolves rc_receiver to USART3 (PB11/PB10) instead of defaulting to
// USART1. CRSF/ELRS, same wiring as BETAFPVG473.
