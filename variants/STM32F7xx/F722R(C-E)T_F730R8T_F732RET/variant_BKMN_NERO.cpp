/*
 * variant_BKMN_NERO.cpp — Board-specific system clock configuration
 *
...
/**
  ...
  *         SYSCLK = 216 MHz for NERO F7 (8 MHz HSE crystal)
  *         8 MHz / 4 = 2 MHz → * 216 = 432 MHz VCO → / 2 = 216 MHz
  *         USB/SDMMC: 432 MHz / 9 = 48 MHz
  * @param  None
  * @retval None
  */
WEAK void SystemClock_Config(void)
{
   ...
   * HSE = 8 MHz external crystal → 216 MHz SYSCLK
   */
