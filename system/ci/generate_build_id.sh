...
# Usage: ./system/ci/generate_build_id.sh <target_directory>
#
 ...
 * 
 * IMPORTANT: This file is auto-generated by system/ci/generate_build_id.sh
...
echo "✓ Generated build ID header: $BUILD_ID_HEADER"
